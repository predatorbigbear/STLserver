...
源码为STLserver_string_view文件夹，指针版本已不再维护。  
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 实测接口4性能比搜狗workflow的hello world例子 qps更高，大约高15%到20%之间.接口4实现逻辑为解析一次http请求，处理若干http头，发送一次redis查询，将查询结果json序列化，打包成http响应返回。   
