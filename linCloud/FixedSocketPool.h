...
struct FixedSocketPool
{
	FixedSocketPool(std::shared_ptr<IOcontextPool> ioPool, std::shared_ptr<std::function<void()>> startFunction, std::shared_ptr<std::function<void()>> starthttpServicePool,
		std::shared_ptr<LOG> log, int beginSize = 200);
